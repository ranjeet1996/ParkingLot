...
public class ParkingLotSystem {
    public static void main(String[] args) {
        ...
        Vehicle v2 = new Vehicle("MZ12AA4454", VehicleType.BIKE, "White", "Hero", "X");
        floorMapping.get(v2.vehicleType).display();
        Ticket Biketict = m1.issueTicket(v2, floorMapping);
        floorMapping.get(v2.vehicleType).display();
        System.out.println("TicketNo:" + Biketict.ticketNo);
        System.out.println("FloorNo:" + Biketict.floor.floorNo);
        System.out.println("EntryTime:" + Biketict.entryTime);
    }
}
